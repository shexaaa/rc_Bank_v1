...
local atms = {
	...
	{name="ATM", id=277, x=472.31, y=-1001.66, z=30.69},
...
RegisterNUICallback('deposit', function(data)
	...
	TriggerEvent("pNotify:SendNotification", {
		text = "<b style='color:white'>Bank</b><br />   <br /> You deposite $" .. data.amountw .. " on your bank account.",
		type = "success",
		timeout = 1400,
		layout = "centerRight",
		queue = "left",
...
RegisterNUICallback('withdrawl', function(data)
	...
	TriggerEvent("pNotify:SendNotification", {
		text = "<b style='color:white'>Bank</b><br />   <br /> You withdraw $" .. data.withdrawl .. " from your bank account.",
		type = "success",
		timeout = 1400,
		layout = "centerRight",
		queue = "left",
